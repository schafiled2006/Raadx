...
Database
Songs table requires these columns: title, artist, album, genre, audio_url, cover_url, created_at. Storage buckets needed: music-files for audio and covers for images, both with public read access.
